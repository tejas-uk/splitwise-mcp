#!/usr/bin/env python3
"""Splitwise MCP SSE/HTTP Server implementation using FastMCP framework."""
...
logger = logging.getLogger("splitwise-fastmcp-sse")

# Initialize FastMCP app with SSE transport
mcp = FastMCP(
